...
- **capture**: Fix mypy type errors in output_tensors field dict
  ([`d54e9a9`](https://github.com/whisperLiang/torchlens/commit/d54e9a99df47442ddc396ca20666203cfbeb5f06))
...
- **ci**: Enable verbose PyPI upload and disable attestations for debugging
  ([`579506d`](https://github.com/whisperLiang/torchlens/commit/579506df2260dd6c7dcf153b52ad6ee42e282191))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **ci**: Fetch tags in release workflow so semantic-release finds v0.1.36
  ([`0f0a3d0`](https://github.com/whisperLiang/torchlens/commit/0f0a3d0895239152b9093c9f0752f957e27724d7))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **ci**: Pin semantic-release to v9 and add debug output
  ([`b68388c`](https://github.com/whisperLiang/torchlens/commit/b68388cfead9d624c569df0c3687bed823cb0ce4))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **ci**: Prevent major version bump on 0.x releases
  ([`db4a31e`](https://github.com/whisperLiang/torchlens/commit/db4a31edfc626a3e38b46e11d644b8b02b06d264))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **ci**: Remove direct URL dependency rejected by PyPI and clean up workflow
  ([`500368b`](https://github.com/whisperLiang/torchlens/commit/500368ba22d50f2235b9be3b87a455b2c81b9891))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **ci**: Use GitHub App token to bypass branch protection in release workflow
  ([`f2cf8ae`](https://github.com/whisperLiang/torchlens/commit/f2cf8ae7450712bb54fcf58a1f2bbb8d3760f076))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **core**: Fix in-place op tracking, validation, and test stability
  ([`326b8a9`](https://github.com/whisperLiang/torchlens/commit/326b8a907a170f8c9e4c7ec16296faaecfa56d51))
...
- **core**: Fix one-liners and small guard additions across codebase
  ([`3d1591b`](https://github.com/whisperLiang/torchlens/commit/3d1591b003675d91191e7a0abc728ad5eb562fae))
...
- **core**: Handle DataParallel, device mismatch, and embedding perturbation
  ([#91](https://github.com/whisperLiang/torchlens/pull/91),
  [`1a0f8b8`](https://github.com/whisperLiang/torchlens/commit/1a0f8b802f738a399d74876f39d121336a1fe855))
...
- **core**: Resolve 52 bugs across 9 waves of correctness, safety, and polish fixes
  ([`d4ca75d`](https://github.com/whisperLiang/torchlens/commit/d4ca75d13defe15f558799be05cb4dcd9d217a45))
...
- **core**: Resolve final remaining bugs #23, #83, #95, #99
  ([`6302662`](https://github.com/whisperLiang/torchlens/commit/630266251861ca505fcd0f33b33d3aa3b21f7c66))
...
- **core**: Resolve remaining low-risk bugs #28, #107, #108, #147
  ([`d8616a0`](https://github.com/whisperLiang/torchlens/commit/d8616a0b1dfa133cd5aeb6bd92af6cdfb2bc566a))
...
- **core**: Resolve remaining open bugs — FLOPs accuracy, PERF-21, mypy types (#19, #154-161)
  ([`da02dc5`](https://github.com/whisperLiang/torchlens/commit/da02dc56b4940cf32c5e319dc4310ffa7e15c0e3))
...
- **decoration**: Cast mode.device to str for mypy return-value check
  ([`45c0ff3`](https://github.com/whisperLiang/torchlens/commit/45c0ff3be8586675817905dcb273e9bad7ac0519))
...
- **decoration**: Clear stale sq_item C slot after wrapping Tensor.__getitem__
  ([`b2c6085`](https://github.com/whisperLiang/torchlens/commit/b2c6085e31695b973b8d11c23c773af837a846cc))
...
- **decoration**: Python 3.14 compat -- two-pass decoration + TypeError catch
  ([#138](https://github.com/whisperLiang/torchlens/pull/138),
  [`e6f0f9a`](https://github.com/whisperLiang/torchlens/commit/e6f0f9a33ba31504d6e402c117aac4a87ef46cb5))
...
- **gc**: Convert back-references to weakrefs and add optional call stack collection
  ([`2bed167`](https://github.com/whisperLiang/torchlens/commit/2bed167d78fed3a143060f8f5d75007cd3a06214))
...
- **gc**: Release ParamLog._param_ref on cleanup, add GC test suite (#GC-1, #GC-12)
  ([`83e1bd2`](https://github.com/whisperLiang/torchlens/commit/83e1bd2df4304b55bff7d59bea8ffe2728ee7c7f))
...
- **logging**: Capture/restore RNG state for two-pass stochastic models
  ([#58](https://github.com/whisperLiang/torchlens/pull/58),
  [`271cef3`](https://github.com/whisperLiang/torchlens/commit/271cef345d8c94e709bc5eeccc8e4d64b951c64d))
...
- **logging**: Ensure output layer parents are saved with layers_to_save
  ([#46](https://github.com/whisperLiang/torchlens/pull/46),
  [`b104094`](https://github.com/whisperLiang/torchlens/commit/b10409445dc036ce8957e4e52e314b3b4a38dc4f))
...
- **logging**: Handle complex-dtype tensors in tensor_nanequal
  ([`b425cbe`](https://github.com/whisperLiang/torchlens/commit/b425cbed76fdaf7bef6f2fc94fa6fdc02404b4c2))
...
- **logging**: Prevent label-steal on no-op same-object returns
  ([`c8ec165`](https://github.com/whisperLiang/torchlens/commit/c8ec1653919660d7b93e26046d3fe3706e40bc42))
...
- **logging**: Replace copy.deepcopy with safe_copy to prevent infinite loops
  ([#18](https://github.com/whisperLiang/torchlens/pull/18),
  [`e1ad9ae`](https://github.com/whisperLiang/torchlens/commit/e1ad9ae08937b11ccffe83c47efc45a052397c6c))
...
- **logging**: Revert children_tensor_versions to proven simpler detection
  ([`ade9c39`](https://github.com/whisperLiang/torchlens/commit/ade9c39f15604459af9134ffcb770ae08238f5cf))
...
- **logging**: Use argspec to disambiguate tuple/list input args
  ([#43](https://github.com/whisperLiang/torchlens/pull/43),
  [`a91e378`](https://github.com/whisperLiang/torchlens/commit/a91e378125e1d3ee0a9483b9240c3f7730faba3a))
...
- **loop-detection**: Group param-sharing ops by func_applied_name + param_barcodes
  ([`f1e795b`](https://github.com/whisperLiang/torchlens/commit/f1e795b05365b6929fbf3a7b3a30446d93073674))
...
- **loops**: Refine iso groups to prevent false equivalence in loop detection
  ([`5aaad70`](https://github.com/whisperLiang/torchlens/commit/5aaad70196073364ecfa7351fba08fed013e81b4))
...
- **misc**: Fix decoration, param detection, vis forwarding, and guards
  ([`4269c4d`](https://github.com/whisperLiang/torchlens/commit/4269c4d35beeabf54468fbc99b083290e830ff98))
...
- **multi**: Resolve 16 test failures across suite
  ([`6fcf72f`](https://github.com/whisperLiang/torchlens/commit/6fcf72f6677ac30cd0f63bfc62250b2c133f028e))
...
- **postprocess**: Backward-only flood in conditional branch detection + THEN labeling
  ([#88](https://github.com/whisperLiang/torchlens/pull/88),
  [`d737828`](https://github.com/whisperLiang/torchlens/commit/d7378281a4be5e56602902cd4cf1aa555b391d44))
...
- **postprocess**: Correct _merge_buffer_entries call convention
  ([#47](https://github.com/whisperLiang/torchlens/pull/47),
  [`07df691`](https://github.com/whisperLiang/torchlens/commit/07df6911dae2d6aa22e13cf2aa2fe4793320e314))
...
- **postprocess**: Fix mypy type errors in _build_module_param_info
  ([`11ea006`](https://github.com/whisperLiang/torchlens/commit/11ea006c9a683675c926a9b0d649a2fa24b46558))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **postprocess**: Gate output node variations on has_child_tensor_variations
  ([`4106be9`](https://github.com/whisperLiang/torchlens/commit/4106be93168cbff4b346a70f06417556c3444490))
...
- **postprocess**: Rebuild pass assignments after loop detection and fix output handler
  ([`847b2a7`](https://github.com/whisperLiang/torchlens/commit/847b2a79202cee13bf2ba231153b71068cf6311a))
...
- **safety**: Add try/finally cleanup and exception state resets
  ([`c9bdb7f`](https://github.com/whisperLiang/torchlens/commit/c9bdb7fc354c0b44f3cfcf6bde17e623a3b6f6db))
...
- **tensor_log**: Use getattr default in TensorLogEntry.copy()
  ([`538288d`](https://github.com/whisperLiang/torchlens/commit/538288d6170ab95ca24e7b88ada37a7e4196d6d2))
...
- **tests**: Add explicit vis_outpath to render_graph calls
  ([`7d7926b`](https://github.com/whisperLiang/torchlens/commit/7d7926b22781e3e78ca9cde166efc9ead7b0ec57))
...
- **tests**: Generate HTML coverage report in sessionfinish hook
  ([`29095f9`](https://github.com/whisperLiang/torchlens/commit/29095f91e19bfbfd0a66a855232247679183d85f))
...
- **tests**: Make SIGALRM signal safety test deterministic
  ([`b3fc461`](https://github.com/whisperLiang/torchlens/commit/b3fc46154f0942c829c3bbeb9b07f3d900471b79))
...
- **tests**: Move coverage HTML output to reports directory
  ([`916b2d1`](https://github.com/whisperLiang/torchlens/commit/916b2d19a0aec297546230a87db1290aea1f9984))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **tests**: Reduce r2plus1d_18 input size to prevent OOM
  ([`2c73fcd`](https://github.com/whisperLiang/torchlens/commit/2c73fcd7af620a29749fd55f753f1b6d3d915b7a))
...
- **tests**: Rename model_kwargs to input_kwargs and fix test configs
  ([`8768339`](https://github.com/whisperLiang/torchlens/commit/87683393e2c38a2703a73643c7b975517bffd589))
...
- **tests**: Use relative import for example_models in test_large_graphs
  ([`e2d0ae4`](https://github.com/whisperLiang/torchlens/commit/e2d0ae476e4d54c2211a3629e8958032c82b1c0f))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **tests**: Use render_graph return value instead of reading cleaned-up .gv file
  ([`7998776`](https://github.com/whisperLiang/torchlens/commit/7998776401752eeedb5693b665114c29234c893d))
...
- **types**: Add mypy annotations for defaultdict and deque in elk_layout
  ([`98478a3`](https://github.com/whisperLiang/torchlens/commit/98478a33a28e890554bad6325478efb8a2ff5f85))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **types**: Move type: ignore to correct lines after ruff reformat
  ([`8205ca4`](https://github.com/whisperLiang/torchlens/commit/8205ca4002ab2f0d0ea5f4b09411735b8ff159a4))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **types**: Resolve 14 pre-existing mypy errors across 4 files
  ([`7adcc36`](https://github.com/whisperLiang/torchlens/commit/7adcc362552697cf8961024d9bc1dcd7a4fb347f))
...
- **types**: Resolve all 181 mypy errors across 18 source files
  ([`546fd94`](https://github.com/whisperLiang/torchlens/commit/546fd9438241da86cf394a03716d8b3dd32391ab))
...
- **types**: Suppress torch.device return-value mismatch in CI mypy
  ([`11922b3`](https://github.com/whisperLiang/torchlens/commit/11922b32aaa6ca5f9769785b4afe737121ae3fae))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **validation**: Batch of bug fixes for edge-case models
  ([`dca5a7e`](https://github.com/whisperLiang/torchlens/commit/dca5a7e11d31c81823601b5b93f79e143cd33c55))
...
- **validation**: Exempt exponential_ from perturbation check
  ([`a6dce40`](https://github.com/whisperLiang/torchlens/commit/a6dce40dc314a36a0296a7c65dd4faf04647b126))
...
- **validation**: Exempt maximum/minimum from perturbation check
  ([`9d658bc`](https://github.com/whisperLiang/torchlens/commit/9d658bc1d80222523ec7e410c0cf1d38665b16f2))
...
- **validation**: Exempt setitem when perturbing all-zeros/all-ones destination
  ([`a3a24ad`](https://github.com/whisperLiang/torchlens/commit/a3a24ad75ba36ffcd1a87994d2c0abc5dce97102))
...
- **validation**: Fix isinstance checks and misleading variable name
  ([`581f286`](https://github.com/whisperLiang/torchlens/commit/581f286fc7c25f50b8b82b44d1f3fcbe03b4f01c))
...
- **validation**: Fix perturbation precision and add exemptions for C++ ops
  ([`7f86655`](https://github.com/whisperLiang/torchlens/commit/7f86655705a8d914126a174ff8b95cf3cc123cee))
...
- **validation**: Handle bool and complex tensor perturbation properly
  ([`dfd2d7b`](https://github.com/whisperLiang/torchlens/commit/dfd2d7be8dce252312235f954446e98357ccfe35))
...
- **validation**: Resolve 14 test failures across validation, labeling, and warnings
  ([`ffc51a5`](https://github.com/whisperLiang/torchlens/commit/ffc51a5be57033ffc1b0506af5a330bd97a343b0))
...
- **validation**: Resolve 8 test failures and Bug #79 in metadata invariants
  ([`14b2e5b`](https://github.com/whisperLiang/torchlens/commit/14b2e5bbb8ac96d0dc45d8f8108db948dbb20097))
...
- **validation**: Scale perturbation range by magnitude for large constants
  ([`efcd876`](https://github.com/whisperLiang/torchlens/commit/efcd8766b38c6ea9f5d3715fac4994509985299b))
...
- **validation**: Use call nesting depth not address depth in invariant Q, fix test inputs
  ([#117](https://github.com/whisperLiang/torchlens/pull/117),
  [`98660ff`](https://github.com/whisperLiang/torchlens/commit/98660ff114f31a2324d3268c0d925cf0b31c02c9))

- **validation**: Use relative threshold for near-constant tensor perturbation
  ([`e0c82c7`](https://github.com/whisperLiang/torchlens/commit/e0c82c7a63e63d2f6e033274d152afc68ecb060b))
...
- **vis**: Add cycle protection to _get_max_nesting_depth and subgraph setup
  ([`8779af9`](https://github.com/whisperLiang/torchlens/commit/8779af9bc95743f55232660432dcf6bcb0055842))
...
- **vis**: Avoid graphviz.Digraph memory bomb when ELK fails on large graphs
  ([`f5563ee`](https://github.com/whisperLiang/torchlens/commit/f5563eee457383772c9b148cca058b87e126b6b3))
...
- **vis**: Bypass ELK for large graphs — use Python topological layout
  ([`37cce3a`](https://github.com/whisperLiang/torchlens/commit/37cce3ab5607591f622b4fd7f5916bca16736d59))
...
- **vis**: Clean up intermediate .gv source files after rendering
  ([`147c7b7`](https://github.com/whisperLiang/torchlens/commit/147c7b7329ae3e86ee1c65dbe61e30a849dd719f))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **vis**: Fix ELK rendering and scale for large graphs
  ([`ea96a85`](https://github.com/whisperLiang/torchlens/commit/ea96a85a766068527366cbe0a77ecd7c7f467eef))
...
- **vis**: Functional ops at end of container modules rendered as ovals
  ([#48](https://github.com/whisperLiang/torchlens/pull/48),
  [`7d1c68c`](https://github.com/whisperLiang/torchlens/commit/7d1c68c502c3274bf1418bfcac2de9d81eef9d77))
...
- **vis**: Harden ELK heap scaling and fix flaky signal safety test
  ([`41b9f89`](https://github.com/whisperLiang/torchlens/commit/41b9f893692bc39a4ea0342092df62b2f2ee2b38))
...
- **vis**: Increase ELK Node.js stack floor to 4GB for large graphs
  ([`29af94e`](https://github.com/whisperLiang/torchlens/commit/29af94ed51b9018ba214f2de15c48e5454a773b3))
...
- **vis**: Increase ELK Node.js stack size to prevent overflow
  ([`b8edbc8`](https://github.com/whisperLiang/torchlens/commit/b8edbc8c779dda44b046c9efa4855b3a6fad46f7))
...
- **vis**: Pass heap limits to ELK Worker thread to prevent OOM on 1M nodes
  ([`23ef8d8`](https://github.com/whisperLiang/torchlens/commit/23ef8d8c175846fce1b48427a0c980a825486b9c))
...
- **vis**: Prevent OOM kill on 1M-node ELK render
  ([#128](https://github.com/whisperLiang/torchlens/pull/128),
  [`d9a1525`](https://github.com/whisperLiang/torchlens/commit/d9a15259e452bf3c224732a0bc5a1671f9cbb56e))
...
- **vis**: Probe nvm paths when node is not on PATH
  ([`4d3ae24`](https://github.com/whisperLiang/torchlens/commit/4d3ae2414bbcc0835d4cb01da230f158004da690))
...
- **vis**: Raise OS stack limit for ELK Node.js subprocess
  ([`da82c9d`](https://github.com/whisperLiang/torchlens/commit/da82c9d0fd66c2fdcbaabb86b31750811693a930))
...
- **vis**: Use Worker thread for ELK layout to fix stack overflow on large graphs
  ([`3fe6a84`](https://github.com/whisperLiang/torchlens/commit/3fe6a84c3d9d8a5856dfadcf451ef85700a2385c))
...
- Add large graph render scripts to scripts/
  ([`d02233b`](https://github.com/whisperLiang/torchlens/commit/d02233bc050657ed6088b8338e056c2c531d45bd))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Add secret detection pre-commit hooks
  ([`0e2889a`](https://github.com/whisperLiang/torchlens/commit/0e2889ae90f822840895d9331e912a570d2a9acf))
...
- Trigger CI
  ([`99f4102`](https://github.com/whisperLiang/torchlens/commit/99f4102fa34564868291214d6b6cf3dfc239fdce))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Update GitHub Actions to use v2 of create-github-app-token and improve token handling
  ([`25af341`](https://github.com/whisperLiang/torchlens/commit/25af3410ce33dcebd51a395f3462a0049004c002))

- **ci**: Add mypy type checking and pip-audit dependency auditing
  ([`2a0e0e7`](https://github.com/whisperLiang/torchlens/commit/2a0e0e725f3551db15221d2bea326018423df880))
...
- **ci**: Add pip caching to quality workflow
  ([`d7573b1`](https://github.com/whisperLiang/torchlens/commit/d7573b18d57bc3e9d20c4c524875ffdb07e4de1f))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **ci**: Remove continue-on-error from mypy check — now a blocking gate
  ([`0e76db0`](https://github.com/whisperLiang/torchlens/commit/0e76db01d0016e1a2b033af29b0b5e4fbc7933b8))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **ci**: Replace black with ruff auto-format on push
  ([`e0cb9e1`](https://github.com/whisperLiang/torchlens/commit/e0cb9e1c20b347cc2ff2579cb10b1beb959f8252))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **ci**: Switch CI from pip to uv for faster installs
  ([`d619ef2`](https://github.com/whisperLiang/torchlens/commit/d619ef212e43c397336a5e0479aa52a47e82569a))
...
- **config**: Add ruff config and replace black/isort with ruff in pre-commit
  ([`c27ced8`](https://github.com/whisperLiang/torchlens/commit/c27ced8f7f8fa9e555dfa6a8313db53575b00305))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **config**: Set major_on_zero to true
  ([`d63451c`](https://github.com/whisperLiang/torchlens/commit/d63451cdd3360fa2ce6979b2e371a806310ec6ca))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **coverage**: Add pytest-cov with HTML and text report generation
  ([`c1ac2c9`](https://github.com/whisperLiang/torchlens/commit/c1ac2c900d334e0ba8e0cff2e6f248e506d15686))
...
- **dev**: Add UI sandbox notebook and nbstripout for clean diffs
  ([`5247361`](https://github.com/whisperLiang/torchlens/commit/524736119646202be37bb8fb30b18d584d0a5a26))
...
- **profiling**: Expand profiling report to 12 models across architecture families
  ([`60e983a`](https://github.com/whisperLiang/torchlens/commit/60e983a4d47c05141bbe6f47929708018b3f5727))
...
- **scripts**: Enable loop detection in render_large_graph
  ([`803e16f`](https://github.com/whisperLiang/torchlens/commit/803e16f3ecec7e2fbb1c662ce963f7de51f4d16c))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **scripts**: Unify large graph render scripts into single parameterized script
  ([`07a8186`](https://github.com/whisperLiang/torchlens/commit/07a8186537cf88bb39f4abae55a05dc01ec16457))
...
- **scripts**: Use log_forward_pass vis_opt instead of separate render call
  ([`d2aea0f`](https://github.com/whisperLiang/torchlens/commit/d2aea0fab326e02444d99aadc7dcf12abf9c8b10))
...
- **tests**: Add @pytest.mark.smoke to 18 critical-path tests
  ([`d26f4ec`](https://github.com/whisperLiang/torchlens/commit/d26f4ec86fbe64f26deb4c40880da4fb5882718c))
...
- **tests**: Move visualization_outputs into tests/ directory
  ([`22ed018`](https://github.com/whisperLiang/torchlens/commit/22ed018d80ce274225bb65bae9a0dda3aed1561b))
...
- **tests**: Rename test_outputs/graphs to test_outputs/visualizations
  ([`fbf1fe6`](https://github.com/whisperLiang/torchlens/commit/fbf1fe66786cf829ed4a26e76a9a934708e92a75))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **tests**: Tidy test_outputs structure and remove private bug numbers
  ([`03817a2`](https://github.com/whisperLiang/torchlens/commit/03817a25f1091f4cb0bf16b9f547cab08ecc515d))
...
- **types**: Remove stale typing noise
  ([`5ba099d`](https://github.com/whisperLiang/torchlens/commit/5ba099df82f789f308f86d78a66c82b1baf3751d))

### Code Style

- Auto-format with ruff
  ([`b9413f1`](https://github.com/whisperLiang/torchlens/commit/b9413f1b4e60511eba117e032df60dea15849354))

### Documentation

- Add folder-wise CLAUDE.md files and comprehensive inline documentation
  ([`deaec2d`](https://github.com/whisperLiang/torchlens/commit/deaec2d4b3fb3c7ffee1fe7f61c8701bdc36dc70))
...
- Move RESULTS.md to repo root for visibility
  ([`2e814dd`](https://github.com/whisperLiang/torchlens/commit/2e814ddbd3421b3c81d7f2518d169a3470c8e9a8))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Update all CLAUDE.md files with deepdive session 4 findings
  ([`b15c5bf`](https://github.com/whisperLiang/torchlens/commit/b15c5bfa665011002a67cdcc7710f4737f1fc5d6))
...
- Update RESULTS.md and tests/CLAUDE.md with current counts
  ([`75fa346`](https://github.com/whisperLiang/torchlens/commit/75fa3463b16505d21b3498a29c848e5da248bd36))
...
- **maintenance**: Refresh maintainer notes
  ([`685a358`](https://github.com/whisperLiang/torchlens/commit/685a358caa12b3210de68e136c59959de4c3f94f))

- **maintenance**: Split CLAUDE.md/AGENTS.md into architect vs implementation roles
  ([`18f8ae9`](https://github.com/whisperLiang/torchlens/commit/18f8ae9851e91be5ca7c335facb45209212f6d95))
...
- **tests**: Add public test results summary
  ([`fd7b33f`](https://github.com/whisperLiang/torchlens/commit/fd7b33ff4f8bf1b4b74548642f70dc58a98f85f7))
...
- Rename all data structure fields and function args for clarity
  ([`f0d7452`](https://github.com/whisperLiang/torchlens/commit/f0d7452e272bede7a874e1bda2dbce68dbb94697))
...
- **build**: Migrate to pyproject.toml with semantic-release and GitHub Actions
  ([`f8e01c9`](https://github.com/whisperLiang/torchlens/commit/f8e01c9f7821a3dd54c9df805bc2181f3340e9ea))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- **capture**: Add func_config field for lightweight hyperparameter extraction
  ([`7144d6d`](https://github.com/whisperLiang/torchlens/commit/7144d6d5200bb17377956ffb8c579553ae34ddfe))
...
- **core**: Add buffer name/module_address properties to LayerLog
  ([#92](https://github.com/whisperLiang/torchlens/pull/92),
  [`e3a1ce2`](https://github.com/whisperLiang/torchlens/commit/e3a1ce21927af0459f1388ed559b0a28a7646bb6))
...
- **core**: Add LayerAccessor and log.layers property
  ([#92](https://github.com/whisperLiang/torchlens/pull/92),
  [`b639e50`](https://github.com/whisperLiang/torchlens/commit/b639e50d793d319d83fc51ecd86c3ac367ad3161))
...
- **core**: Add LayerLog aggregate class with per-layer metadata
  ([#92](https://github.com/whisperLiang/torchlens/pull/92),
  [`9c6472d`](https://github.com/whisperLiang/torchlens/commit/9c6472db6c71c10dbed02428844972f23ebb96b3))
...
- **core**: Generalize in-place op handling, fix loop grouping, and harden validation
  ([`c72d6a6`](https://github.com/whisperLiang/torchlens/commit/c72d6a6ecabd42471c1badd1b6cb8b0b6958e518))
...
- **core**: Permanent toggle-gated decoration of torch functions
  ([`cbeaa83`](https://github.com/whisperLiang/torchlens/commit/cbeaa83aa08098ea721e319a2f1af9a559279892))
...
- **data**: Add FuncCallLocation class for structured call stack metadata
  ([`49ada0e`](https://github.com/whisperLiang/torchlens/commit/49ada0ef1415441562c2f3dd5b71d36de8478472))
...
- **data**: Add MACs properties to LayerPassLog, LayerLog, ModelLog, ModuleLog
  ([`c60e7b9`](https://github.com/whisperLiang/torchlens/commit/c60e7b9a2fd29de09d82c5be076e75c6e4c8b39d))
...
- **data**: Add ModuleLog, ModulePassLog, and ModuleAccessor
  ([`5b0baa8`](https://github.com/whisperLiang/torchlens/commit/5b0baa84903cd7e89f4192fa94fb444eebf5ceb5))
...
- **data**: Add ParamLog class for structured parameter metadata
  ([`f21f3e9`](https://github.com/whisperLiang/torchlens/commit/f21f3e9c7a57facd2dfd0bcf7b5c76da66b62fe2))
...
- **data_classes**: Add BufferLog subclass and BufferAccessor for first-class buffer support
  ([`5a9b4c6`](https://github.com/whisperLiang/torchlens/commit/5a9b4c6bc7079176eaa4b259144b7316ef13699c))
...
- **decoration**: Add global undecorate override
  ([`b0bafeb`](https://github.com/whisperLiang/torchlens/commit/b0bafeb51fbf9b406bd34a84ed826cd4b9c607bb))

- **decoration**: Lazy wrapping — import torchlens has no side effects
  ([`b5da8b8`](https://github.com/whisperLiang/torchlens/commit/b5da8b8b15136f108534ba29022ab6579bdb9315))
...
- **flops**: Add per-layer FLOPs computation for forward and backward passes
  ([`31b43e6`](https://github.com/whisperLiang/torchlens/commit/31b43e6659d521f0332b99d02e969b4ac19f1abd))
...
- **logging**: Add verbose mode for timed progress messages
  ([`0603f10`](https://github.com/whisperLiang/torchlens/commit/0603f1035b8be7c2c44a416099fac282eaafa686))
...
- **logging**: Generalize was_getitem_applied to has_child_tensor_variations
  ([`1177f60`](https://github.com/whisperLiang/torchlens/commit/1177f607bf6406d47424c8b05755aec86d992dcb))
...
- **metadata**: Track module training mode per submodule
  ([#52](https://github.com/whisperLiang/torchlens/pull/52),
  [`e5197ca`](https://github.com/whisperLiang/torchlens/commit/e5197ca2e48d4510df750ea420196e68f038c0b6))
...
- **modules**: Add shared module alias lookup and explicit alias fields
  ([`c2fb14e`](https://github.com/whisperLiang/torchlens/commit/c2fb14ef15fd27bdd352b2e27b99c4866c5706bd))
...
- **tests**: Restructure test suite into focused files with metadata coverage
  ([`31b0353`](https://github.com/whisperLiang/torchlens/commit/31b0353813353a0eaa0dc94e9659f9e84bbaab00))
...
- **validation**: Add complex semantic invariants M-R to check_metadata_invariants
  ([`b745db8`](https://github.com/whisperLiang/torchlens/commit/b745db826135e0470df75d70eaa6dcce48feae42))
...
- **validation**: Add validate_forward_pass with metadata invariant checks
  ([`8a25ede`](https://github.com/whisperLiang/torchlens/commit/8a25ede7f90b4e924f06e55ad15bb46d148f7384))
...
- **validation**: Capture and restore autocast context during logging and replay
  ([`19bbcb6`](https://github.com/whisperLiang/torchlens/commit/19bbcb665c55f9e022263b51f673a781d5b80410))
...
- **vis**: Add ELK layout engine for large graph visualization
  ([`5245872`](https://github.com/whisperLiang/torchlens/commit/5245872746ee07dddd41a222392aa7548e33ce3f))
...
- **vis**: Add hierarchical module grouping to ELK layout
  ([`bcc1ad2`](https://github.com/whisperLiang/torchlens/commit/bcc1ad207aa2d9512960201594bfa9afc2495fb0))
...
- **vis**: Scale ELK rendering to 250k+ nodes, add detect_loops option
  ([`4707631`](https://github.com/whisperLiang/torchlens/commit/470763146ce30334b5853cfc7cfd104035fd9922))
...
- **viz**: Add dagua torchlens integration
  ([`35d5bcd`](https://github.com/whisperLiang/torchlens/commit/35d5bcdb976420b86be54048ab4503cbbc146763))

### Performance Improvements

- **capture**: Lazy _fsize_nice properties, remove _trim_and_reorder, batch pause_logging, drop
  deepcopy
  ([`986bd91`](https://github.com/whisperLiang/torchlens/commit/986bd914a317be6acde0a4c0898a417fb9f6dcbb))
...
- **capture**: O(1) tensor/param extraction via per-function ArgSpec lookup table
  ([`b1d6c56`](https://github.com/whisperLiang/torchlens/commit/b1d6c56f4f1c5cf1176232e8fc33e229f8555baf))
...
- **capture**: Speed-optimized defaults and remaining bottleneck elimination
  ([#110](https://github.com/whisperLiang/torchlens/pull/110),
  [`7c9a00c`](https://github.com/whisperLiang/torchlens/commit/7c9a00cdec26258090cf6be1c93869cb82aa351a))
...
- **decoration**: Optimize model prep and move session attrs to ModelLog dicts
  ([`b63a4fa`](https://github.com/whisperLiang/torchlens/commit/b63a4fa3871113a5cc73554c576fb11c5eac2cd2))
...
- **logging**: Optimize 5 hot-path bottlenecks in log_forward_pass
  ([`d4a5d3a`](https://github.com/whisperLiang/torchlens/commit/d4a5d3a57e52a22c6b312e8b77f3ec6a6d896efc))
...
- **model_prep**: Optimize _prepare_model_session for large models
  ([`2892323`](https://github.com/whisperLiang/torchlens/commit/2892323ac2910532c9bbde894280ba917a72e966))
...
- **postprocess**: Optimize 6 remaining hot-path bottlenecks in log_forward_pass
  ([`ed62350`](https://github.com/whisperLiang/torchlens/commit/ed623508d8f8353634066cc4702d39bf8f0ca981))
...
- **postprocess**: Optimize pipeline for large models
  ([`a211417`](https://github.com/whisperLiang/torchlens/commit/a2114170b4f5b441d4c0ab7add26435820fc8f8f))
...
- **batch1**: Aesthetic cleanup — names, types, docstrings for small files
  ([`52efdc1`](https://github.com/whisperLiang/torchlens/commit/52efdc1e8ec55e1b5047589903f3a601523dfe14))
...
- **batch2**: Aesthetic cleanup — names, types, docstrings for medium files
  ([`8610c46`](https://github.com/whisperLiang/torchlens/commit/8610c464a2106d8037198852fb7fa7acba6ed808))
...
- **batch3**: Aesthetic cleanup — names, types, docstrings for medium-large files
  ([`74c0850`](https://github.com/whisperLiang/torchlens/commit/74c085095276e0361607d6d3226df85ffa8e8187))
...
- **batch4**: Aesthetic cleanup — names, types, docstrings for large files
  ([`ce19825`](https://github.com/whisperLiang/torchlens/commit/ce19825710472895b0b644881d6db3bacea50e84))
...
- **core**: Modulelog.all_layers now stores unique no-pass labels
  ([#92](https://github.com/whisperLiang/torchlens/pull/92),
  [`214e161`](https://github.com/whisperLiang/torchlens/commit/214e1616e87ab89a9f7e6a44de8d7e6453bdf430))
...
- **core**: Remove buffer name/module_address from LayerLog
  ([#92](https://github.com/whisperLiang/torchlens/pull/92),
  [`f896dd4`](https://github.com/whisperLiang/torchlens/commit/f896dd41c24f4174b70395db0fb174c8b70f1e44))
...
- **core**: Remove RolledTensorLog, use LayerLog for rolled visualization
  ([#92](https://github.com/whisperLiang/torchlens/pull/92),
  [`118b3ec`](https://github.com/whisperLiang/torchlens/commit/118b3ec67be88274d80634a79f38e87f1c70e27e))
...
- **core**: Rename TensorLog → LayerPassLog + nomenclature sweep
  ([`d328476`](https://github.com/whisperLiang/torchlens/commit/d32847669bc0d2410d6f1070865f53c81de84b98))
...
- **core**: Replace 17 flat module_* dicts on ModelLog with transient _module_build_data
  ([`ef3f20e`](https://github.com/whisperLiang/torchlens/commit/ef3f20ef16422a4c997a2727cf9c9df941e56030))
...
- **data**: Convert 23 stored fields to computed @properties across data classes
  ([`2c22208`](https://github.com/whisperLiang/torchlens/commit/2c22208a72636bb796268510a3529cf1183519eb))
...
- **data**: Move ModelHistory & TensorLogEntry into data_classes/
  ([`6ecc7e5`](https://github.com/whisperLiang/torchlens/commit/6ecc7e5880eadffd8c13e82bd39d3aa9c5544672))
...
- **data**: Rename ModelHistory/TensorLogEntry to ModelLog/TensorLog
  ([`f36718e`](https://github.com/whisperLiang/torchlens/commit/f36718e6a471838ef40af0e25e8e41357d9b9a30))
...
- **design**: Algorithmic review pass — efficiency, correctness, robustness
  ([`78924f8`](https://github.com/whisperLiang/torchlens/commit/78924f825f2b604fe7dcd1df234ce76d23c51ad6))
...
- **design**: Mid-level design pass — dataclasses, decomposition, parameter bundles
  ([`0849edb`](https://github.com/whisperLiang/torchlens/commit/0849edb605bb63a469831dd1959c1bd8236ce964))
...
- **loops**: Cherry-pick approved changes from feat/loop-detection-hardening
  ([`33e0f22`](https://github.com/whisperLiang/torchlens/commit/33e0f223d12aae806799f3853ed6e221b1232274))
...
- **postprocess**: Split monolithic postprocess.py into thematic package
  ([`cd14d27`](https://github.com/whisperLiang/torchlens/commit/cd14d2744ea60db3a911905c377fc6c52123a1cc))
...
- **qa**: Address naive reader findings — docstrings, comments, variable names
  ([`22724af`](https://github.com/whisperLiang/torchlens/commit/22724afb26e6511365eee5c6ce6bdf97888eeb12))
...
- **structure**: Reorganize into focused subpackages
  ([`2cfa90a`](https://github.com/whisperLiang/torchlens/commit/2cfa90ac15e8e325c9e417202b0d884450c43915))
...
- **types**: Finish package mypy cleanup
  ([`6f9a3fe`](https://github.com/whisperLiang/torchlens/commit/6f9a3fe423367c9bd9e32949cdf06945d90786ee))

- **validation**: Restructure into subpackage with data-driven exemption registries
  ([`ff85efd`](https://github.com/whisperLiang/torchlens/commit/ff85efd282df188e5202d35944c0782ed1e16c3f))
...
- **vis**: Migrate vis.py and interface.py from module_* dicts to ModuleAccessor API
  ([`8e64d43`](https://github.com/whisperLiang/torchlens/commit/8e64d439d78081551c4112c0cc49b8c300609296))
...
- Mark test_validation_250k as slow
  ([`a960cb2`](https://github.com/whisperLiang/torchlens/commit/a960cb27c2bbd36340367f5e0dc20f18c7336f64))
...
- Mark test_validation_50k as rare
  ([`8070f8e`](https://github.com/whisperLiang/torchlens/commit/8070f8eed80216b0bb07f4c38be94367ce405ce6))
...
- Skip test_validation_250k unconditionally
  ([`bd756b2`](https://github.com/whisperLiang/torchlens/commit/bd756b2c679ee19f1f03bf1b0335f298ef91f089))
...
- **aesthetic**: Add aesthetic testing infrastructure for visual inspection
  ([`73cdf01`](https://github.com/whisperLiang/torchlens/commit/73cdf017c29f2385cebb721e7b08b88177807365))
...
- **aesthetic**: Add gradient visualization coverage
  ([`085dcd9`](https://github.com/whisperLiang/torchlens/commit/085dcd9caf95b1ca364f83a7f97bd020f611c521))
...
- **aesthetic**: Add LaTeX PDF report with embedded visualizations
  ([`d101326`](https://github.com/whisperLiang/torchlens/commit/d101326906573b95d62f5d518b13ee4be7025cb9))
...
- **decoration**: Comprehensive tests for permanent decoration architecture
  ([`f6305c8`](https://github.com/whisperLiang/torchlens/commit/f6305c8c0f30337bdb2e5f6f265b0d253b7bb05e))
...
- **models**: Add autoencoders, state space models, and architecture coverage
  ([`716cc9d`](https://github.com/whisperLiang/torchlens/commit/716cc9dc425eb6245886eb7873c7a212db16d4d5))
...
- **models**: Close remaining stress-test gaps — MAML, NeRF, RecurrentGemma, VOLO
  ([`a1f2254`](https://github.com/whisperLiang/torchlens/commit/a1f22543bcc2cbb22b2008121a5082e64a534860))
...
- **models**: Exhaustive architecture coverage across 30+ categories
  ([`8411a72`](https://github.com/whisperLiang/torchlens/commit/8411a725439819de55a54f4339afa21410f67686))
...
- **models**: Exhaustive coverage expansion — 20 toy + 33 real-world architectures
  ([`4f4e7ae`](https://github.com/whisperLiang/torchlens/commit/4f4e7aeb958e35ed7845b03b209367d8d55e5ab0))
...
- **models**: Final coverage pass — 6 novel computational patterns
  ([`e33c71a`](https://github.com/whisperLiang/torchlens/commit/e33c71a0cec2a64fce944aa36a42690fe3f6fe15))
...
- **models**: Gap-fill 8 toy models + 21 real-world models for exhaustive coverage
  ([`7d5f879`](https://github.com/whisperLiang/torchlens/commit/7d5f879bdefc9547d7341eea8b9c8adda3fd7e9f))
...
- **profiling**: Add automated profiling report for overhead measurement
  ([`a483011`](https://github.com/whisperLiang/torchlens/commit/a483011785da9ee4f5dd5957c083d9e67f9f7e82))
...
- **profiling**: Add decoration overhead benchmark to profiling report
  ([`c8fbffd`](https://github.com/whisperLiang/torchlens/commit/c8fbffdc43b4f97a2e7ab90cecd78a8d59950592))
...
- **reorganize**: Redistribute bugfix tests into domain-specific test files
  ([`e9c64cc`](https://github.com/whisperLiang/torchlens/commit/e9c64cc58a6bbd8f5d1b9942d234af3e0eed94bd))
...
- **suite**: Exhaustive test suite expansion (~559 tests)
  ([`b489120`](https://github.com/whisperLiang/torchlens/commit/b489120b91af4e41496cd206ce9ad20ab0a37092))
...
- **validation**: Add meta-validation tests for corruption detection
  ([`11de9da`](https://github.com/whisperLiang/torchlens/commit/11de9da7209b3f504dd3ed6433a0d04367c38d22))
...
- **vis**: Add rare marker for 250k-node tests, fill test coverage gaps
  ([`c749b94`](https://github.com/whisperLiang/torchlens/commit/c749b94e69a1eee18f9084c1f46efc472fb3fe72))
