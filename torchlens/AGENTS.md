...
- `_trace_core/`: private columnar store substrate (typed columns, per-trace intern
  ...
  sparse overlays, `TraceCore` with COW fork). Zero production consumers until the Op
  seam; architecture of record in `docs/reference/trace_core_design.md`. The declared
