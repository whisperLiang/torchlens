...
_LAZY_ATTRS = {
    ...
    "after": ("torchlens.split", "after"),
    "BoundarySchema": ("torchlens.split", "BoundarySchema"),
    "SplitFeatures": ("torchlens.split", "SplitFeatures"),
    "SplitGraphIR": ("torchlens.split", "SplitGraphIR"),
    "SplitModelProfile": ("torchlens.split", "SplitModelProfile"),
    "SplitPoint": ("torchlens.split", "SplitPoint"),
    "SplitRequest": ("torchlens.split", "SplitRequest"),
    "SplitVerificationStatus": ("torchlens.split", "SplitVerificationStatus"),
    "ReplayBoundary": ("torchlens.split", "ReplayBoundary"),
    "SplitRuntime": ("torchlens.split", "SplitRuntime"),
    "before": ("torchlens.split", "before"),
    "percent": ("torchlens.split", "percent"),
    "prepare": ("torchlens.split", "prepare"),
