...
| `edge_intervention_save_unsupported` | Save of a trace carrying tier-(ii) edge-substitution entries under the frozen tlspec v7 (all four levels refuse at the v7 boundary; spelling DOCUMENTED-UNSTABLE) | Save the un-edited source trace; edge-substitution persistence lands at the coordinated bump |
